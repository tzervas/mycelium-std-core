# Gap status — `mycelium-std-core`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-std-core` |
| **Role** | std.core |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-std-core-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Guarantee matrix baseline |
